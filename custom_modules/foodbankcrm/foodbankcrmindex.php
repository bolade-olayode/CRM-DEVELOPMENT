...
/**
 *	\file       foodbankcrm/foodbankcrmindex.php
 *	\ingroup    foodbankcrm
 *	\brief      Home page of foodbankcrm top menu
 */
...
//if (!isModEnabled('foodbankcrm')) {
//	accessforbidden('Module not enabled');
//}
//if (! $user->hasRight('foodbankcrm', 'myobject', 'read')) {
//	accessforbidden();
//}
//restrictedArea($user, 'foodbankcrm', 0, 'foodbankcrm_myobject', 'myobject', '', 'rowid');
//if (empty($user->admin)) {
...
llxHeader("", $langs->trans("FoodbankCRMArea"), '', '', 0, 0, '', '', '', 'mod-foodbankcrm page-index');

print load_fiche_titre($langs->trans("FoodbankCRMArea"), '', 'foodbankcrm.png@foodbankcrm');
...
// Draft MyObject
if (isModEnabled('foodbankcrm') && $user->hasRight('foodbankcrm', 'read')) {
	$langs->load("orders");
...
if (isModEnabled('foodbankcrm') && $user->hasRight('foodbankcrm', 'read')) {
	...
	$sql.= " FROM ".MAIN_DB_PREFIX."foodbankcrm_myobject as s";
